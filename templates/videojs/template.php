...
function template_header($preview = false)
{
    $components = array(
        ...
        "stylesheets" => array("style.min.css", "juicycodes.css"),
        "javascripts" => array("ie8.min.js", "video.min.js", "plugin.js", "juicycodes.js"),
    );
    return $components;
}
...
function template_body($source = array(), $subtitle = false, $preview = false, $slug, $dl = false)
{
    ...
    $html = '
    <video id="video_player" class="video-js vjs-big-play-centered">' . $subtitles . '</video>
    ';
    $script = '
    var config = {
